...
TCL_EXTRA_CFLAGS='-g -O2 -fno-omit-frame-pointer -mno-omit-leaf-frame-pointer -ffile-prefix-map=/build/tcl8.6-4nG7pL/tcl8.6-8.6.14+dfsg=. -flto=auto -ffat-lto-objects -fstack-protector-strong -fstack-clash-protection -Wformat -Werror=format-security -fcf-protection -fdebug-prefix-map=/build/tcl8.6-4nG7pL/tcl8.6-8.6.14+dfsg=/usr/src/tcl8.6-8.6.14+dfsg-1build1 -fno-unit-at-a-time -pipe -Wdate-time -D_FORTIFY_SOURCE=3'
...
TCL_LD_FLAGS='-Wl,-Bsymbolic-functions -flto=auto -ffat-lto-objects -Wl,-z,relro -Wl,--export-dynamic '
