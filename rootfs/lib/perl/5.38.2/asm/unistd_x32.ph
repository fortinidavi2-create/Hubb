...
unless(defined(&_ASM_UNISTD_X32_H)) {
    ...
    eval 'sub __NR_futex_waitv () {( &__X32_SYSCALL_BIT + 449);}' unless defined(&__NR_futex_waitv);
    eval 'sub __NR_set_mempolicy_home_node () {( &__X32_SYSCALL_BIT + 450);}' unless defined(&__NR_set_mempolicy_home_node);
    eval 'sub __NR_cachestat () {( &__X32_SYSCALL_BIT + 451);}' unless defined(&__NR_cachestat);
    eval 'sub __NR_fchmodat2 () {( &__X32_SYSCALL_BIT + 452);}' unless defined(&__NR_fchmodat2);
    eval 'sub __NR_futex_wake () {( &__X32_SYSCALL_BIT + 454);}' unless defined(&__NR_futex_wake);
    eval 'sub __NR_futex_wait () {( &__X32_SYSCALL_BIT + 455);}' unless defined(&__NR_futex_wait);
    eval 'sub __NR_futex_requeue () {( &__X32_SYSCALL_BIT + 456);}' unless defined(&__NR_futex_requeue);
    eval 'sub __NR_statmount () {( &__X32_SYSCALL_BIT + 457);}' unless defined(&__NR_statmount);
    eval 'sub __NR_listmount () {( &__X32_SYSCALL_BIT + 458);}' unless defined(&__NR_listmount);
    eval 'sub __NR_lsm_get_self_attr () {( &__X32_SYSCALL_BIT + 459);}' unless defined(&__NR_lsm_get_self_attr);
    eval 'sub __NR_lsm_set_self_attr () {( &__X32_SYSCALL_BIT + 460);}' unless defined(&__NR_lsm_set_self_attr);
    eval 'sub __NR_lsm_list_modules () {( &__X32_SYSCALL_BIT + 461);}' unless defined(&__NR_lsm_list_modules);
